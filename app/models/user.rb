...
class User < ApplicationRecord
  ...
  has_many :follower_relationships, class_name: 'FollowRelationship', foreign_key: 'follower_id', dependent: :destroy, inverse_of: :following
  has_many :followers, through: :follower_relationships, source: :following

  # フォローしたときの処理
  def follow(user_id)
    following_relationships.create!(follower_id: user_id)
  end
